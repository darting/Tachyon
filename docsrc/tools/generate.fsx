...
let githubLink = "https://github.com/Horusiath/Tachyon"

// Specify more information about your project
let info =
  [ "project-name", "Tachyon"
    "project-author", "Bartosz Sypytkowski"
    "project-summary", "Distributed reactive actor model framework for .NET"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Tachyon" ]
